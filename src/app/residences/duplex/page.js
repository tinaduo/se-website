...
export default function Duplex() {
  return (
    <>
      <header>
        <title>Residences - Duplex | The Seventy-Eight Collection</title>
        <meta
          name="description"
      ...
      <main className="flex flex-col min-h-screen">
        <div className="bg-[#3D6663] p-12 md:p-24">
          ...
          <p className="text-white text-center text-lg md:text-2xl mt-4">
            5 BEDROOMS | 4.5 BATHROOMS | 2,894 SQFT. (APPROX)
          </p>
        </div>
        <section className="flex flex-col items-center justify-center p-6 md:p-12">
          <div className="flex flex-col lg:grid lg:grid-cols-3 lg:grid-rows-1 gap-4">
            <div className="flex flex-col items-center gap-4">
              <img
                src="/images/residences/duplex/basement.png"
            ...
            <div className="flex flex-col items-center gap-4">
              <img
                src="/images/residences/duplex/mainfloor.png"
                alt="Mainfloor Floor Plan"
                className="w-full h-auto"
              />
              <p className="flex flex-col text-center text-2xl font-bold text-[#FBC048] uppercase">
                Main Floor
                <span className="font-medium text-[#3D6663]">985 SQFT.</span>
              </p>
            </div>
            <div className="flex flex-col items-center gap-4">
              <img
                src="/images/residences/duplex/upperfloor.png"
