      ...
      <main className="flex flex-col min-h-screen">
        <div className="bg-[#3D6663] p-12 md:p-24">
          <h1 className="text-white text-center text-4xl md:text-6xl font-semibold font-['Lora']">
            SINGLE-FAMILY LOT 11
          </h1>
          <p className="text-white text-center text-lg md:text-2xl mt-4">
            5 BEDROOMS | 4 BATHROOMS | 4,976.17 SQFT. (APPROX)
          </p>
        </div>
        <section className="flex flex-col items-center justify-center p-6 md:p-12">
          <div className="flex flex-col lg:grid lg:grid-cols-3 lg:grid-rows-1 gap-4">
            <div className="flex flex-col items-center justify-end gap-4">
              <img
                src="/images/residences/single-family/lot11/basement.png"
                alt="Basement Floor Plan"
                className="w-full h-auto"
              />
              <p className="flex flex-col text-center text-2xl font-bold text-[#FBC048] uppercase">
                BASEMENT
                <span className="font-medium text-[#3D6663]">1,668 SQFT.</span>
              </p>
            </div>
            <div className="flex flex-col items-center justify-end gap-4">
              <img
                src="/images/residences/single-family/lot11/mainfloor.png"
                alt="Mainfloor Floor Plan"
                className="w-full h-auto"
              />
              <p className="flex flex-col text-center text-2xl font-bold text-[#FBC048] uppercase">
                Main Floor
                <span className="font-medium text-[#3D6663]">1,778 SQFT.</span>
              </p>
            </div>
            <div className="flex flex-col items-center justify-end gap-4">
              <img
                src="/images/residences/single-family/lot11/upperfloor.png"
                alt="Upperfloor Floor Plan"
                className="w-full h-auto"
              />
              <p className="flex flex-col text-center text-2xl font-bold text-[#FBC048] uppercase">
                Upper Floor
                <span className="font-medium text-[#3D6663]">1,530 SQFT.</span>
              </p>
            </div>
          </div>
        </section>

        <section className="flex flex-col justify-center items-center gap-6 mx-6 mb-24">
          <h1 className="text-[#3D6663] text-6xl font-semibold text-center font-['Lora']">
