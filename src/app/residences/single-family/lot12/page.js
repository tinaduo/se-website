        ...
        <section className="flex flex-col items-center p-6 md:p-12">
          <div className="flex flex-col lg:grid lg:grid-cols-3 lg:grid-rows-1 gap-4">
            <div className="flex flex-col items-center justify-end gap-4">
              <img
                src="/images/residences/single-family/lot12/basement.png"
            ...
            <div className="flex flex-col items-center justify-end gap-4">
              <img
                src="/images/residences/single-family/lot12/mainfloor.png"
            ...
            <div className="flex flex-col items-center justify-end gap-4">
              <img
                src="/images/residences/single-family/lot12/upperfloor.png"
